...
from wav2sql import beam_search
# noinspection PyUnresolvedReferences
...
from wav2sql.datasets.spider import SpiderDataset
from wav2sql.models.spider import spider_beam_search
...
class Inferer:
    ...
    def infer(self, model, output_path, args):
        ...
        with torch.no_grad():
            if args.mode == 'infer':
                orig_data = SpiderDataset(**self.config['data']['dev'])
