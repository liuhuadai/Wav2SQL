...
from wav2sql.models import attention
from wav2sql.models import variational_lstm
from wav2sql.models.nl2code.infer_tree_traversal import InferenceTreeTraversal
from wav2sql.models.nl2code.train_tree_traversal import TrainTreeTraversal
from wav2sql.models.nl2code.tree_traversal import TreeTraversal
...
class NL2CodeDecoder(torch.nn.Module):
    ...
    def __init__(
        ...
        if use_align_mat:
            from wav2sql.models.spider import spider_dec_func
